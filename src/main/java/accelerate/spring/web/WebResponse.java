...
import com.walgreens.springboot.lang.ApplicationException;
...
public class WebResponse extends DataBean {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.walgreens.core.data.DataBean#toShortJSON()
	 */
	/**
	 * @return
	...
	public String toShortJSON() throws ApplicationException {
		return JSONUtils.serializeOnly(this, "returnCode", "viewName", "message");
	}
